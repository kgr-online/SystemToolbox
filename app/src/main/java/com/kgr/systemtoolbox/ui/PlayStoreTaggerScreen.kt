...
import com.kgr.systemtoolbox.modules.AppInfo
import com.kgr.systemtoolbox.modules.FilterMode
import com.kgr.systemtoolbox.modules.PlayStoreTaggerViewModel
import com.kgr.systemtoolbox.modules.TagMode
import com.kgr.systemtoolbox.modules.TaggerUiState
    ...
    ScreenScaffold(title = Screen.PlayStoreTagger.title, onBack = onBack) {
        when (val s = state) {
            ...
            is TaggerUiState.NoRoot -> {
                Text(
                    "Root access not available. Grant root to System Toolbox and try again.",
